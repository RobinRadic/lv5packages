...
use Exception;
use LaradicAdmin\Attributes\Models\Value;
...
trait EntityTrait
{
    ...
    {
        return $this->hasValues('LaradicAdmin\Attributes\Models\Value', 'entity');
    }
     ...
     * @param  string $key
     * @param  mixed  $value
     * @return \LaradicAdmin\Attributes\Models\Value|bool
     */
     ...
     *
     * @param  \LaradicAdmin\Attributes\Models\Value $valueInstance
     * @param  mixed                                     $value
     * @return \LaradicAdmin\Attributes\Models\Value|bool
     */
     ...
     *
     * @param  string $key
     * @return \LaradicAdmin\Attributes\Models\Attribute
     */
