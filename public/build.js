({
    ...
    baseUrl : "frontend/default/namespaces/theme/assets/scripts",
    optimizeCss: false,
    modules: [
        { name: "boot", exclude: [ ] },
        { name: "theme", exclude: [ "boot" ], include: ["autoloader", 'config', 'eventer', 'gfm', 'highlighter', 'json', 'share-buttons', 'storage'] },
        { name: "Codepad", exclude: [ "theme", "boot" ] },
        { name: "github-editor", exclude: [ "theme", "boot", "Codepad" ] },
        { name: "demo", exclude: [ "github-editor", "theme", "boot", "Codepad" ] },
    ],
    dir: "_build",
    optimize: "none",
    removeCombined: true
